...
import ru.nsu.ccfit.beloglazov.socksproxyserver.socks.SocksResponse;
...
public class ConnectHandler extends Handler{
    ...
    public static SocketChannel initTargetSocket(
            Connection clientConnection, SelectionKey selectionKey,
        ...
        Connection targetConnection = new Connection(clientConnection.getObservableOutputBuffer(), clientConnection.getObservableInputBuffer());
